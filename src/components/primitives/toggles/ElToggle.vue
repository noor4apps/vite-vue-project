...
// css class for the inner span element
...
<template>
  <button type="button" role="checkbox" :data-testid="testid" :aria-checked="checked" :disabled="disabled" :class="cssClass" @click="handleClick">
